...
import pedrogonvalle.com.github.android_crypto_monitor.service.MercadoBitcoinServiceFactory
        ...
        CoroutineScope(Dispatchers.Main).launch {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    val lblValue: TextView = findViewById(R.id.label_value)
                    val lblDate: TextView = findViewById(R.id.label_date)
